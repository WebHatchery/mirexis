...
impl Game {
    pub fn cycle_selected_character(&mut self, delta: i32) {
    ...
    pub fn cycle_selected_mission(&mut self, delta: i32) {
    ...
    pub fn controller_confirm_tactical(&mut self) {
...
pub fn targeted_confirm_action(
    session: &GameSession,
...
pub fn field_notes_overlay_input(
...
pub fn first_hour_help_overlay_input(
    help_open: bool,
    escape_pressed: bool,
    cancel_pressed: bool,
) -> Option<UiAction> {
...
impl Game {
    ...
    fn capture_state_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
        match self.state {
            AppState::Title => self.title_input(input, pad),
            AppState::Colony => self.colony_input(input, pad),
            AppState::Roster | AppState::GeneLab => self.roster_appstate_genelab_input(input, pad),
            AppState::MissionBriefing => self.missionbriefing_input(input, pad),
            AppState::Tactical => self.tactical_input(input, pad),
            AppState::Debrief => self.debrief_input(input, pad),
            AppState::DemoComplete => self.democomplete_input(input, pad),
        }
    }

    fn title_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
    ...
    fn colony_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
        if input.escape_pressed || pad.cancel {
    ...
    fn roster_appstate_genelab_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
        if input.escape_pressed || pad.cancel {
    ...
    fn missionbriefing_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
        if input.escape_pressed || pad.cancel {
            self.events.push(UiAction::ReturnToColony);
        }
    ...
    fn tactical_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
    ...
    fn debrief_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
    ...
    fn democomplete_input(&mut self, input: &InputState, pad: &GamepadFrame) -> bool {
