...
fn mirexis_paths_change_defense_supply_and_recovery() {
    ...
    assert!(redoubt
        ...
        .buildings
        .iter()
        .any(|building| building.kind == mirexis::colony::BuildingKind::RedoubtArsenal));
    assert_eq!(
    ...
    assert!(commonwealth
        ...
        .buildings
        .iter()
        .any(|building| building.kind == mirexis::colony::BuildingKind::ChoirGarden));
    ...
    assert!(threshold
        ...
        .buildings
        .iter()
        .any(|building| building.kind == mirexis::colony::BuildingKind::ThresholdSpire));
    assert_eq!(
...
fn matching_mirexis_operation_reveals_the_chosen_campaign_end() {
    ...
    for (path_id, template_id, post_template_id, ending_title, modifier, objective_kind) in [
        (
            ...
            "THE LAST WALL HOLDS",
            mirexis::data::OperationModifier::MirexisRedoubt,
            mirexis::data::ObjectiveKind::DefendAsset,
        ),
        (
            "living_commonwealth",
            "mirexis_commonwealth_root_choir",
            ...
            mirexis::data::OperationModifier::MirexisCommonwealth,
            mirexis::data::ObjectiveKind::SignalTrace,
        ),
        (
            "open_threshold",
            "mirexis_threshold_door_of_light",
            ...
            mirexis::data::OperationModifier::MirexisThreshold,
            mirexis::data::ObjectiveKind::SecureAndClear,
        ),
    ] {
        let mut campaign = CampaignState::new(&data);
