use super::*;
use mirexis::campaign::{SalvageChoice, SALVAGE_MATERIALS_REWARD, SALVAGE_RESEARCH_INSIGHT};
use mirexis::colony::{BuildingKind, BuildingState};
use mirexis::state::MissionOutcome;
