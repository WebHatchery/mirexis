use super::*;
use mirexis::data::{Team, UnitDef};
use mirexis::tactical::UnitState;
...
fn briefing_modifier_copy_stays_inside_the_left_briefing_column() {
    ...
    mission.operation_modifier = mirexis::data::OperationModifier::EscalationCrossfire;
    ...
    assert!(modifier.bottom() < mirexis::briefing_deployment_ui::deployment_row_bounds(5, 0).y);
}
