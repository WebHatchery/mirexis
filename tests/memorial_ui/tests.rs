...
fn record_count_collects_scars_recovery_and_legacies() {
...

    {
        ...
        character.traumas.push(mirexis::trauma::TraumaRecord {
            id: "clouded_eye".to_owned(),
            name: "Clouded Eye".to_owned(),
            effect: "-8 ACC · +1 DMG".to_owned(),
        });
        character.injuries.push(mirexis::campaign::InjuryRecord {
        ...
        character
            .event_legacies
            .push(mirexis::campaign::CharacterLegacy {
                id: "legacy".to_owned(),
...
fn record_count_includes_lost_objectives() {
    ...
    campaign
        .lost_objectives
        .push(mirexis::campaign::LostObjectiveRecord {
