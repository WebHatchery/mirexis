use super::*;
use mirexis::relationships::RelationshipRecord;
use mirexis::trauma::TraumaRecord;
...
fn epilogue_names_the_mireborn_timeline_when_sedge_survives() {
    ...
    campaign
        .colony
        .buildings
        .push(mirexis::colony::BuildingState {
            id: "waystation_epilogue_sedge".to_owned(),
            kind: mirexis::colony::BuildingKind::Waystation,
            position: [2, 11],
            level: 1,
            damaged: false,
        });
