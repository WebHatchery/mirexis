...
fn character_save_gains_colony_without_losing_progress() {
    ...
    assert!(migrated
        .campaign
        .colony
        .has_facility(mirexis::colony::BuildingKind::Workshop));
...
fn doctrine_save_gains_sustainable_colony_infrastructure() {
    ...
    campaign.colony.buildings.retain(|building| {
        !matches!(
            building.kind,
            mirexis::colony::BuildingKind::Hydroponics | mirexis::colony::BuildingKind::PowerPlant
        )
    });
    ...
    assert!(migrated
        .campaign
        .colony
        .has_facility(mirexis::colony::BuildingKind::Hydroponics));
    assert!(migrated
        .campaign
        .colony
        .has_facility(mirexis::colony::BuildingKind::PowerPlant));
...
fn adaptation_operation_save_gains_an_existing_gene_lab() {
    ...
    assert!(migrated
        ...
        .buildings
        .iter()
        .any(|building| building.kind == mirexis::colony::BuildingKind::GeneLab));
}
