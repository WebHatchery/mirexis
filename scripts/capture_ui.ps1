...
#>
param(
    [string[]]$Scenes = @("title", "colony", "damage", "power", "construction", "research", "roster", "legacy", "briefing", "pressure", "gameplay", "extraction", "variant", "sporefield", "vault", "equipment", "class_target", "breach", "debrief"),
    [int]$Frames = 150,
