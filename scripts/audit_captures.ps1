...
$lines.Add("- ``ui_redoubt_end.png``, ``ui_commonwealth_end.png``, and ``ui_threshold_end.png``: the identity ending card and bounded colony legacy register remain inside the open Operations drawer.")
...
$lines.Add("- ``ui_roster.png`` and ``ui_recruited_roster.png``: the complete equipment catalog clears the footer instruction baseline in both roster variants.")
