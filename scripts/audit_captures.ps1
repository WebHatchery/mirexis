...
$lines.Add("- ``ui_battle_log.png`` and ``ui_phase_replay.png``: attack history and hostile replay beats name HIT/MISS outcomes alongside the underlying roll and target chance.")
$lines.Add("- ``ui_combat_feedback.png``: hit, miss, critical, damage, recovery, objective, and cover callouts remain anchored to their affected field locations.")
