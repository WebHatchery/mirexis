...
$lines.Add("- ``ui_roster.png``, ``ui_recruited_roster.png``, ``ui_roster_info.png``, and ``ui_advanced_roster.png``: the complete workshop equipment catalog stays inside the training panel and above the footer instruction line, with a persistent touch inspection reference.")
