...
Audit baseline: save/content 1.148.0, validated and committed with this matrix
...
| D05 | City supplies direction, preparation, character connection, and visible consequences | `first_hour_ui.rs`, `first_hour_investment_ui.rs`, colony conversations and Operations treatment controls with a shared prerequisite predicate, outcome-sensitive `first_hour_consequences_ui.rs`, clear debrief goal/result layering, fielded-versus-reserve squad disclosure including recruited fielded colonists, recruited-roster list coverage, deployed-squad XP disclosure, and colony/debrief captures | VERIFIED |
