...
Audit baseline: save/content 1.133.0, validated and committed with this matrix
...
| Overlay/focus/resize input safety | First-hour, settings, Facility Upgrades, and Salvage Yard overlays consume underlying physical input; modal input clearing and map-release tests | VERIFIED |
