...
Audit baseline: save/content 1.149.0, validated and committed with this matrix
...
| D05 | City supplies direction, preparation, character connection, and visible consequences | `first_hour_ui.rs`, `first_hour_investment_ui.rs`, colony conversations plus prerequisite-aware Operations treatment and research controls, outcome-sensitive `first_hour_consequences_ui.rs`, clear debrief goal/result layering, fielded-versus-reserve squad disclosure including recruited fielded colonists, recruited-roster list coverage, deployed-squad XP disclosure, and colony/debrief captures | VERIFIED |
