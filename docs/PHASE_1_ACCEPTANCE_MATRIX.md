...
Audit baseline: save/content 1.122.0, validated and committed with this matrix
...
| D06 | First investment has a clear observable effect | Three 24-material preparations, persistent Operations breadcrumb in `ui_first_hour_operations.png`, and `first_investment_changes_only_the_second_deployment` | VERIFIED |
