...
| S28 | Memorial Register | Permanent scars, recovery records, failed objectives, and character legacies need a touch-visible revisit surface | No colony cost-and-legacy register | PASS |
...
| Final implementation gate | `cargo fmt --package mirexis -- --check`; 520 Mirexis unit tests, source-size gate, and strict Clippy with warnings denied | PASS |
