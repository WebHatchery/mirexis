...
| battle_log | Battle log | Secondary combat, recovery, objective, and cover outcomes use generic ACTION labels or fall into unrelated filters | `ui_battle_log.png` | PASS |
