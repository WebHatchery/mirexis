...
| S28 | Memorial Register | Permanent scars, recovery records, and character legacies need a touch-visible revisit surface | No colony cost-and-legacy register | PASS |
...
| memorial | Memorial Register | Permanent costs and character legacies were only visible in specialist screens | `ui_memorial.png` | PASS |
...
| Final implementation gate | `cargo fmt --package mirexis -- --check`; 518 Mirexis unit tests, source-size gate, and strict Clippy with warnings denied | PASS |
...
| Final full capture | `FINAL_CAPTURE_INVENTORY.md`; 103 PNGs, SHA-256 digests, and machine audit in `capture_audit.json` | PASS |
