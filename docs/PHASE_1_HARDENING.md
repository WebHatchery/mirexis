...
- 447 Mirexis unit tests pass, including deployment-row affordance coverage for full,
  ...
  availability-label coverage, objective interaction-label coverage, and Overwatch
