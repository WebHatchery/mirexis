...
| Overlay input safety | Help, settings, battle log, and hostile replay clear underlying release actions; settings also consumes keyboard/controller commands until its visible RETURN or Escape/B close path is used | Repeat on touch-primary browsers |
