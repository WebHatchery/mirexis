...
- 444 Mirexis unit tests pass, including deployment-row affordance coverage for full,
  ...
  outsider shortfall-label coverage, and tactical target-gate label coverage.
