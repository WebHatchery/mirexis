...
| Overlay input safety | First-hour field guide, tactical help, battle log, and hostile replay clear underlying release actions; settings also consumes keyboard/controller commands until its visible RETURN or Escape/B close path is used | Repeat on touch-primary browsers |
