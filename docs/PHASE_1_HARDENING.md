...
- 491 Mirexis unit tests pass, including deployment-row affordance coverage for full,
  ...
  attack-outcome event-summary, callout-lane geometry, recovery-audio, and battle-log
  event-grouping coverage,
